            ...
            <div className="container" darktheme={this.state.darkTheme.toString()}>
                <div className="top-bar">
                    ...
                    <label htmlFor="theme-toggle-checkbox" className="theme-changer-container">
                        <input type="checkbox" id="theme-toggle-checkbox" style={{ display: 'none' }} onInput={this.changeTheme} />
                ...
                <div className="search-container">
                    <div className="search-bar">
                        ...
                        <input type="text" id="search-input" className="search-input" onInput={event => { event.persist(); this.setState({ searchTerm: event.target.value }) }} />
                    </div>
